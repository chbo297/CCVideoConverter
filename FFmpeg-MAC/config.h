...
#define FFMPEG_CONFIGURATION "--libdir=cc_lib --incdir=cc_include --enable-shared --disable-runtime-cpudetect --disable-doc --enable-gpl --enable-nonfree --enable-libmp3lame --enable-libtheora --enable-libvorbis --enable-libvpx --enable-libx264 --enable-libx265 --enable-libopus --enable-libxvid"
